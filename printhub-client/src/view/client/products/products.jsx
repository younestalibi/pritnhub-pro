...
const items = [
    {   
      ...
      name: "Business Cards",
      image: image1,
      description: "Business Cards are a collection of business cards that can be used to manage your business",
      products: [
        { 
    ...
    {   
      key: "banners-signs",
      name: "Banners & Signs",
      description: "Banners & Signs for quick distribution with additional information about the product",
      products: [
        { 
          key: "vinyl-banners",
          name: "Vinyl Banners",
...
export default function ProductList(){
  ...
  const categoryItem = items.find(item => item.key === category);
        if (!categoryItem || !categoryItem.products || categoryItem.products.length === 0) {
          return (
